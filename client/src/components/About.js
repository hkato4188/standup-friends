      ...
      <div className="list-card">
        ...
        <div className="about-text">
          ...
          <p>
            ...
            fostered sense of shared responsibility and accountability while you
            track your tasks to resolution.{" "}
          </p>
          <p>
            ...
            identifying obstacles, that allow more time to adapt to a situation
            and respond with an effective solution resolution. Most importantly,
            this app helps users stay on track with their goals and maintain a
            strong focus on delivering value to the customer.
          </p>
